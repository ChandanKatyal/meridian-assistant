...
### How this works
 ...
 -**lib/groq.ts**: This file has HTTP call to the model. If the response is not okay, the function throws an error with the status code of that particular error.
